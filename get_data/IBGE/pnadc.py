...
class GetPNADc:
    def __init__(self):
        ...
        # base_url_pnadc = "https://servicodados.ibge.gov.br/api/v3/agregados/8163/periodos/"
        # final_part = "/variaveis/7167|7168|11623|11624|11625|11626?localidades=N1[all]&classificacao=11046[all]|1274[all]"

        base_url_pnadc = "https://servicodados.ibge.gov.br/api/v3/agregados/6381/periodos/"
        final_part = "/variaveis/4099?localidades=N1[all]"

        url_ibge = f"{base_url_pnadc}{gaf.generate_ibge_period_sequence(first_year_to_get_data, current_year + 1)}{final_part}"
