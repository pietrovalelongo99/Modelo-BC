...
name_ibge_data = os.path.basename(__file__)[:3]
...
class GetPMS:
    def __init__(self):
        ...
        # Construct the URLs
        first_year_to_get_data = 2011
        name_of_this_file = name_ibge_data
        # base_url_pms = "https://servicodados.ibge.gov.br/api/v3/agregados/8163/periodos/"
        # final_part = "/variaveis/7167|7168|11623|11624|11625|11626?localidades=N1[all]&classificacao=11046[all]|1274[all]"

        base_url_pms = "https://servicodados.ibge.gov.br/api/v3/agregados/8688/periodos/"
        final_part = "/variaveis/7168?localidades=N1[all]&classificacao=11046[56726]|12355[all]"

        url_ibge = f"{base_url_pms}{gaf.generate_ibge_period_sequence(first_year_to_get_data, current_year + 1)}{final_part}"
