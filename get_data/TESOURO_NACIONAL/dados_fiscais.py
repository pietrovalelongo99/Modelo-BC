...
# tem dados de API nesse site - mas ele é mt confuso, muitas siglas.
# https://www.gov.br/tesouronacional/pt-br/central-de-conteudo/apis
# A partir dele, parece que esse eh o correto:
...
def __init__():
    ...
    base_url_pib = "http://apidatalake.tesouro.gov.br/docs/siconfi/"
